...
https://python-sounddevice.readthedocs.io/en/0.3.15/_downloads/18a22eb28ce7c72a33ea364b61b4fe9c/spectrogram.py
...
try:
    ...
    with sd.InputStream(
        ...
        samplerate=samplerate) as iStream:
